...
function Jobs() {
  ...
  return (
    <section>
      ...
      <div className='lg:flex justify-evenly XL:pt-4 pt-6'>
        <div className='grid md:grid-cols-2 gap-4 ml-8'>
        {jobs.map((job, index) => (
          <div key={index} className='xl:w-84 bg-white rounded-lg shadow-md hover:shadow-lg mr-8 mb-8'>
      ...
      <div className='flex flex-col gap-4 mx-8'>
                  <div className='bg-teal-100 xl:w-84 h-fit pb-8 rounded-lg shadow-md hover:shadow-lg'>
                      ...
                      {/*--tags part--*/}
                      <div className='mt-6 flex flex-col gap-3 mx-4'>
                          <h2 className='text-xl font-semibold mx-4 mt-6'>Tags</h2>
                  ...
                  {/*--hiring--*/}
                  <div className='xl:w-84 h-fit pb-8 bg-gray-700 mb-8 rounded-lg shadow-md hover:shadow-lg'>
